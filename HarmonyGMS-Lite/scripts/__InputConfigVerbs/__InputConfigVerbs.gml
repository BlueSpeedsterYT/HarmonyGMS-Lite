function __InputConfigVerbs()
{
    ...
    if (INPUT_ON_SWITCH)
    {
        InputDefineVerb(INPUT_VERB.JUMP,    "jump",          "A",   gp_face2);
        InputDefineVerb(INPUT_VERB.ATTACK,  "attack",        "S",   gp_face1);
        InputDefineVerb(INPUT_VERB.CONFIRM, "confirm",       "A",   gp_face2);
        InputDefineVerb(INPUT_VERB.CANCEL,  "cancel",        "S",   gp_face1);
    }
    else
    {
