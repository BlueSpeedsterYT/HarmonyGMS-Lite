...
/// @description Checks if the given collider's mask intersects an 'arm' of the player's virtual mask.
/// @param {Asset.GMObject|Id.Instance|Id.TileMapElement|Array} ind Object, instance, or tilemap to check, or an array containing any of these.
/// @param {Real} xrad Distance to extend the player's mask horizontally both ways.
/// @param {Real} yoff Distance to offset the line vertically.
/// @returns {Bool}
player_armcast = function(_ind, _xrad, _yoff)
{
    var x_int = x div 1;
    var y_int = y div 1;
    var sine = dsin(mask_direction);
    ...
    var x1 = x_int;
    var y1 = y_int;
    var x2 = x_int + cosine * _xrad + sine * _yoff;
    var y2 = y_int - sine * _xrad + cosine * _yoff;
