...
#macro GAME_OVER_START_X (CAMERA_WIDTH_CENTER + 20)
#macro GAME_OVER_FADE_1_X (CAMERA_WIDTH_CENTER - time_to_frames(0, 1))
#macro GAME_OVER_FADE_2_X (GAME_OVER_FADE_1_X - 10)
#macro GAME_OVER_END_X (CAMERA_WIDTH_CENTER - time_to_frames(0, 2))
#macro TIME_OVER_START_X (CAMERA_WIDTH_CENTER + 60)
#macro TIME_OVER_PAUSE_X (CAMERA_WIDTH_CENTER + 20)
#macro TIME_OVER_PAUSE_DURATION (time_to_frames(0, 1) + time_to_frames(0, 2 / 3))
#macro TIME_OVER_RESUME_X (TIME_OVER_PAUSE_X - TIME_OVER_PAUSE_DURATION)
#macro TIME_OVER_FADE_DURATION time_to_frames(0, 2)
#macro TIME_OVER_FADE_1_X (CAMERA_WIDTH_CENTER + 30)
#macro TIME_OVER_FADE_2_X (TIME_OVER_RESUME_X - 10)
#macro TIME_OVER_END_X (TIME_OVER_RESUME_X - 40)
