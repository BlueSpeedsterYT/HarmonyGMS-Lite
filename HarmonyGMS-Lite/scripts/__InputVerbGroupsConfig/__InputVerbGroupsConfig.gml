...
function __InputVerbGroupsConfig()
{
    ...
    InputVerbGroupDefine(INPUT_VERB_GROUP.STAGE, [INPUT_VERB.JUMP, INPUT_VERB.ATTACK, INPUT_VERB.TRICK]);
    InputVerbGroupDefine(INPUT_VERB_GROUP.SYSTEM, [INPUT_VERB.CONFIRM, INPUT_VERB.CANCEL]);
}